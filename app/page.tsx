          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
            <div className="md:w-1/2 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                >
                  <Button variant="outline" className="w-full sm:w-auto border-blue-400/50 text-blue-400 hover:bg-blue-400/10 hover:border-blue-400/70 font-medium py-3 px-8 rounded-lg transition-all duration-200 text-lg">
                    Live Demo
                  </Button>
                </a>
              </div>
