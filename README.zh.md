...
> **企业级正常运行时间监控，创业公司价格** - 每年只需50美元，而不是竞争对手的360美元以上，即可实现99.9%可靠的网站和API监控。
...
1.  **我的网站/API 是否正常运行？**
2.  **它能否立即通知我** — 通过手机、Slack、Discord 或电子邮件？

仅此而已。我们不需要花哨的动画仪表盘或企业销售电话。

### 当前解决方案存在的问题

大多数工具将基本功能隐藏在昂贵的付费墙后面：
- 📱 **移动推送通知？** *高级功能 - $20/月*
- 🔗 **API 访问/Webhooks？** *高级功能 - $10/月*
- 🌍 **全球监控？** *高级功能 - $15/月*
- 🔒 **SSL 监控？** *高级功能 - $10/月*

**总计：每年 $360+**，而这些功能运行成本只需几美分。
...
由 [Sunil Agrwal](https://www.linkedin.com/in/sunilagwl5/) (前InMobi，Bareuptime) 创建，BareUptime 的诞生源于对那些为基本功能收取数百美元的昂贵企业监控工具的厌倦。
