...
[![应用启动](https://img.shields.io/badge/App-Launch-green?style=for-the-badge&logo=rocket)](https://app.bareuptime.co)
[![GitHub Star 数](https://img.shields.io/github/stars/sumansaurabh/bareuptime?style=for-the-badge)](https://github.com/sumansaurabh/bareuptime)

> **企业级正常运行时间监控，创业公司价格** - 您的网站和 API 监控，99.9% 的可靠性，每年只需 50 美元，而不是竞争对手的 360+ 美元。

## 🤔 为什么选择 BareUptime？

传统的正常运行时间监控工具**价格离谱**。我们真正需要的只是一个能回答两个简单问题的系统：

1. **我的网站/API 正常运行吗？**
2. **它能立即通知我吗** — 在手机、Slack、Discord 或电子邮件上？

就是这样。我们不需要花哨的动画仪表盘或企业销售电话。
...
这不是风险投资支持的臃肿软件。以下是您每年 50 美元的具体用途：
...
- 📱 [iOS 应用商店](https://apps.apple.com/app/bareuptime) - *即将推出*
- 🤖 [Google Play 商店](https://play.google.com/store/apps/details?id=co.bareuptime.app) - *即将推出*
...
由 [Suman Saurabh](https://linkedin.com/in/ssumansaurabh) (前微软，Penify) 构建，BareUptime 的创建源于对高价企业监控工具的不满，这些工具对基本功能收取数百美元。

**我们的使命**：以创业公司友好的价格提供企业级监控基础设施。

---

⭐ **如果 BareUptime 对您的项目有所帮助，请给我们一个星标！** 这有助于其他开发者找到这个经济高效的监控解决方案。
