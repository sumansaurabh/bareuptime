...
import { Shield, Activity, Mail, Smartphone, Zap, AlertTriangle, Check, Lock, TrendingUp, Slack } from 'lucide-react'
...
const MonitoringAnimation = () => {
  ...
  const nodes = [
    ...
    { id: 'slack', x: 520, y: 205, icon: Slack, label: 'Slack', color: 'green', size: 'normal' },
